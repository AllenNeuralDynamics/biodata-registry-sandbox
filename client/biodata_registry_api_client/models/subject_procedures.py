...
class SubjectProcedures(BaseModel):
    """
    SubjectProcedures
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["id", "created_at", "created_by", "updated_at", "last_updated_by", "data", "schema_id", "space_id", "subject_id"]
