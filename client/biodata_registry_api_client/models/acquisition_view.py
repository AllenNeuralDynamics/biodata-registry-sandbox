...
class AcquisitionView(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["acquisition_id", "subject_id", "acquisition_data", "instrument_name", "instrument_data", "data_asset_location", "data_asset_name", "data_asset_data", "data_asset_external_links", "subject_name", "subject_data", "quality_control_data"]
