...
async def get_processes(
    ...
    if all(item is None for item in [process_id, schema_id, space_id]):
        raise HTTPException(
...
async def create_processes(
    ...
    base_statement = "INSERT INTO processes (schema_id, space_id, data) VALUES (:schema_id, :space_id, :data) RETURNING *;"
