...
@router.get("/specimen_procedure_inputs", tags=["specimen_procedure_inputs"])
async def get_specimen_procedure_inputs(
    ...
    base_statement = "SELECT * FROM specimen_procedure_inputs"
    or_statement = ""
    param_dict = dict()
...
@router.post("/specimen_procedure_inputs", tags=["specimen_procedure_inputs"])
async def create_specimen_procedure_inputs(
    ...
    base_statement = "INSERT INTO specimen_procedure_inputs (specimen_id, specimen_procedure_id) VALUES (:specimen_id, :specimen_procedure_id) RETURNING *;"
...
@router.delete("/specimen_procedure_inputs", tags=["specimen_procedure_inputs"])
async def delete_specimen_procedure_inputs(
    specimen_id: int = Query(
        alias="specimen_id",
    ),
    specimen_procedure_id: int = Query(
    ...
    base_statement = "DELETE FROM specimen_procedure_inputs WHERE specimen_id = :space_admin_id AND specimen_procedure_id = :specimen_procedure_id RETURNING *;"
    param_dict = {"specimen_id": specimen_id, "specimen_procedure_id": specimen_procedure_id}
    statement = text(base_statement)
    result = await session.execute(statement, param_dict)
    rows = []
